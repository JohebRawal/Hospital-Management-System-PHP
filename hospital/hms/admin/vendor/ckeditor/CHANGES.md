...
* Accessibility issues (mainly in inline editor): [#9364](http://dev.ckeditor.com/ticket/9364), [#9368](http://dev.ckeditor.com/ticket/9368), [#9369](http://dev.ckeditor.com/ticket/9369), [#9370](http://dev.ckeditor.com/ticket/9370), [#9541](http://dev.ckeditor.com/ticket/9541),$Û#972] èpdp*//dev.ckeditob.!om+pickav/9543), [#941_(http:'/dev®kcedi|or.c/m/tIâkE4.=84q)¬`[c9844](httt:/oeev.cieditob.com/tmckeô/9844),
* [Mauic LkNå_(Htvpº//`jetit/r.gom/!àdon/meGic|in%	 `lugin:  € * [#951](http:o'fet.kkeditor.bom/t)c/e4/968(:`AdDed acqessibilhty {uppoòt fz MaGiÃ line.
    ) [#¹509]*èttp:¯/dev.#+E$étnR.áom-tmsKet/9509): Added M gic Li,e&supp-r4 for vorms/
$   * [#=57"](`ttq:ï/$gv.cyådyTor.âomtéckut/9173) Magic Linm does$not di[appTar gn@`mouseoutb in0` spec)faã case>
* Û#9754](hvtp:/-dev.ckeeitorjCoo/tIkkeô/;754©: [SecKit} c5ttanw & pa7pifo sieple unnmòmatted umht oeketaves an anlkne w2qppr kn Webkit browscrs.* ["9456](jttpº/-fmv.ckeditor.com/tiCketo945&i: [ChromeQ$properl} past% bullet lhst(sdyle from MS Wgr`j* [#9v99Y(hvtð:/+dEf.ckedipor.com/tiBkev/y699), [#9758](httð://eev.cke`itor/ãmm/tickez/)758): Imxroved selection locki.ç WhE~ selecving by dpaGgidc*Š* GkntmXô menu
    ("[#9712]¨httP¾//Dev.kketitor.com/tIckeT/)·12©: Openinç the Conteht menu deStroys dhtor fofUs,* b  * [#9362(jôtp//deö>ckedi4kr.aom=ticket/9366+: Coltext menu shoumd bu dhsplayed over thu"bloatxng`To/lbav>
 " $h`[#976M http://dev.ck%dipor/com/tég+et?9706: Sonteøt }Enp genmraxås a JavisCrytv error"in inliîe mo`e(when the meirov is attabheD to a jeade2 Dlemunt.
*0[#980 ]((4pp;//dev.ckeditoò.ck-/ticëet/9800): Hide!float qane, 7hen resizijg the wi.doW.
* [#=72#](hTtp:/-dev.ckDditoú.com/tkckMt/9·21)8 Pádding in!aontEnt of dév-based edmtoR puts0tHe EDitiìg(area uO$ev t(ehbttOm UI0stace®
* [39528](xtx2:?¯de~*ckedk4or,com/ôiÃked/928): HGct page `zox-smz)ng` ótyle sho}ld .-t$inføuence the ed)to2 UI elumenps.
* [#9e03U(httxº//dev.skçditop.b{m/Ticet/9503): [FïsmElementq](hdpp2//cKediTorns/m/yddgn&foRmó(!plwgin áddc contåxt oefu }istef%rs onl{ on`{upPoúted inp}p ô{pes. Added suppoòt foò atul`, àemam|`. hsmérbh` ald `urlè in0ud tytes.-(`[#9769](xttq:/kfel.gkadidmr.gom/vacket/9769): Mm0roveâ floating toolbar$pïsitioni~g i~&a lÁrrow wijdow.
* [c874]¸ittp://`ev.c)edétó.col/tikkeU-9875#: Table dialg wandow les ~ot Popul`tå 7Adth0cOrråcôl{.	
* [#8675}¨httPzo/dev,c{editor/#omoTikkmto=¶75): De,Et)nc ceìls iî a îeqtad(tablA remöe3 the outeV taBle celL.
+ [9815(`ptp:¯/eev:cketItos.g¯-/tmcket/985i: Cannt edit diaD`g0~indow fheLds in a, editor énitiádizåd i 4hE *QuEry"UI mOdal dialc..0[%x¸8(}(http:/.deö.#ieditor.soo+tácket/88¸i: FKEdiôo2 diano'¥7in$owr lm Fot(sàkw cgmqletely in ! small uindown
* [#-360](ht|p:/'dev.ckEd)uor,cïm.ô)c{et/93>0):"[Ioline edk|orX Bloc{s shmwn"fob(a @<div>` alumen|(ótcy periqnenÔly E~dn afver thm(usår ehits eliting"tHe `<tiv~`.
* [#97s1]hôdp://dev®g+eDitoRcom/qicket'95s0):![FIrefo| & Mnline efitor] Toonbár is host$wàdn closyng t(e foPíat dbo0-dow~ li{t by glicoilc i0s buôtol.
*(Y!9553](http:/&deö.cKedatob.ckm/|icket/%53)> Tábla`wid|h$inãorre#tly$set"when the `border-wittHa spyld ir specifiM6.* [#95y4](htdp:¯dew.ckEdivor>gom/ticket9=94)8!Gaî~ot dab¢xast CKEditgsdwhen ip Is in read-o.ly m?,g.MŠ( [³9618_(httr://devâëeditop.gom/ticjgt¯92=8)º![ÉE9Ý0Justiæy no$ Wopkiîg on seleceD i-cwes.
* [#9¶(6](h|tp:-/eev.bcåditor®com/tickeô/9&8): Ideed!misshn' contEìts!ã|ilaw voz `¼pze>à g,åme.tc.
* [#7 9]¬htpq:./ddv.coeditor.Gom/|iaket/9p9): [Paste nrgm WObe]ªhttp:/-cKediôk2®com/!ddlj£paspefRoíword)$should not äupend on cïnF)guratioo fvoi o4her stxles.-( [#9726_(http:'/dev>ciåditor.aom?ticket/972&) Removed [Color @iálog],http://ckeditnr.com/ad`oj/cofordhiloÇ= pl7gin(dåpejtency &rom0[TabLe omw}8hTtp8//IKedmtor.aom.adäon/uablewoods)
*0[+9765](éttp:o'emv¾+keditor.#om/ô)cket/87>5); Tnolb`R(Collarge!c/mMand foc}í%fped incorbectl9 iî dHe [Qccåssiiiliti In{druc|ionsy(httpz'/sKmditor,coM'!ddnn/a!1yhelp) dialog uindow.-
* _+9771](httP8'.dev.c+editor.cEm/tickEt/9771+: [webKit & Opeza] Fixed Scrolling isrugs when qastknG.
* [#1687ý)hutp://dew.ciatitos.coíoticket/5w¸5)* [IA9]"`oNChange` is not fized for gheckfoPes"in dialoGr.M
*`Yc986r](lttp:'d%v.ckedktor.com¯Dickdtoh$2):$YFiref/x 0¿] Whan0ïpening a0toolba2 menu b)r"the$äizst tioå an` pressang the *Dëwn Aspow* ke{, focuS goes to*thí`naxt ôooìbaw `uttoj insteád nf the mg®u qtions.
* [#=86'](hdpp:/+dev.cëedit/z.com/tickuô/1><7): [Elementó Path]¨hTvP://ck¥$itor.c/m¯ad$ïj'Eleomntwpath) siïuyd .kt ba é/)tialized in tie aolife editoú,
((Zƒ9857Ý(hwtp://de6.ckediTor.cm/ticKet.=851): [`Editor/addSml/veFormatFiltåw()ð¨httt://doks.ckeditor.coe/'#/api/CKDDITOR&editor-letèod%addRemovgFormatFi,tes)$is mxtosed bå$gre ét realnq wnrkó.
* [#(03](http:/odev.cEd)torvcm/phcket/<8y3+: Valwe of the Û`pasteBso}_ovdCleafupVile`](htt0://docsnckeditkr.coM/#/api?CKEÄHTOR,ãonfig-cfo-`asteBromVordCìaanuqBI|e) conæiguration opwiO~ ió now taëe~ frmm¨t(e instaNãe cOnfigõ2atig/.
j [96+s](hô|p;//dev*ckedmtGr.c/m/ticket/9693): Òeooved""Ìiwe QrevieW"!checkbox fpom QI ckmor$pi#kern


#c CCEdavos 4/0
The first sôable re|eqså of the ~e CKEäitkb"$!cofE liîef

Th! [
Adit/r JawáScripx`ATI has nedn kept$coí0ati"he!vith$CKEditoò"4¬ sjenevdr+pwssable. The mist on relevaft changeó can be fmundpin uhe [PI G`ang%s page!od
Thå0CCEfitob¢ doãumentathïn][}.

[1U:$hpöp/¯locs.cktäitor.com/#!'guidtgde6_#pi_bxa"ges "API ChqlGes"